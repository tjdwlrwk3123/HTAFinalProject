...
insert into accom_info values(8,10,'[업체소개]
ㅁ 도심속 휴식공간 모꼬지에 오신 것을 환영합니다!
모꼬지는 서울의 심장 종로 혜화동, 대학로 주택가에 자리잡은 한옥 게스트하우스입니다.
놀거리와 볼거리, 먹거리가 풍성한 혜화동에 위치하고있습니다.
...
[부대시설]
ㅁ 공용주방 (매일 아침 간단한 토스트와 주스,커피 제공)

[주변관광지]
ㅁ 창덕궁,종묘,경복궁,혜화문,짚풀생활사박물관,코난방탈출카페,시크릿챔버','인원추가요금]
ㅁ 기준인원 초과시 1인당 추가비용 : 20.000원 (현장결제)
ㅁ 각 객실마다 정해진 최대수용인원(영유아포함) 초과를 엄격히 금하며, 예약된 인원외에는 숙소에 입실 할 수 없습니다
...
ㅁ 객실 및 기타시설물은 다른 사용자를 위해서 깨끗이 사용해 주시기 바랍니다
ㅁ 다른 이용 고객의 불편함이 없도록 무분별한 오락, 음주 및 고성방가를 자제하여 주시기 바랍니다
ㅁ 쾌적하고 안락한 숙소 운영 방침에 따라 최대정원 이상의 입실은 금합니다
ㅁ 화재 및 냄새로 인한 타 손님 배려 차원에서 객실 내 돼지고기, 생선, 청국장등의 조리를 금하오니 실외 지정된 장소 및 바비큐장을 이용하시길 부탁드립니다
ㅁ 이용 시 시설물에 대한 책임은 투숙객에게 있으므로 유의하시기 바랍니다
ㅁ 이용자의 귀중품 분실시 책임은 이용자에게 있으니 관리 부탁드립니다
ㅁ 시설물 훼손, 파손 시에는 숙소관리자에게 알려주시기 바랍니다
ㅁ 객실 내에서는 금연입니다
ㅁ 애완동물은 부득이 타 객실 및 손님을 위해 입실을 금하오니 양해바랍니다
ㅁ 미성년자는 보호자의 동행 없이는 투숙이 불가합니다
ㅁ 퇴실시 음식물을 비롯한 모든 쓰레기는 분리수거해 주시고, 사용하신 주방기구는 세척해 주시기 바랍니다
ㅁ 객실 정리 후 퇴실점검을 받으셔야 합니다. 점검 후 객실 키를 반납해 주세요','- 체크인 6일 전 : 취소 수수료 없음
- 체크인 5일 전 : 취소 수수료 10%
- 체크인 4일 전 : 취소 수수료 20%
- 체크인 3일 전 : 취소 수수료 30%
- 체크인 2일 전 : 취소 수수료 50%
- 체크인 1일 전 : 취소 수수료 70%
- 체크인 당일 : 취소 수수료 100%','체크인 - 14:00 / 체크아웃 - 11:00','바베큐','wifi,조식');
