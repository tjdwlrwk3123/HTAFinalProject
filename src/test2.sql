...
(
	...
	question_number number NOT NULL,
	answer_title varchar2(100) NOT NULL,
...
(
	...
	review_answer_title varchar2(100) NOT NULL,
	user_id varchar2(200) NOT NULL,
	cate_number number NOT NULL,
	service_number number(5) NOT NULL,
...
(
	...
	user_id varchar2(200) NOT NULL,
	service_answer_title varchar2(100) NOT NULL,
...
create sequence service_question_seq --coupon
start with 1
increment by 1;

create sequence service_answer_seq --coupon
start with 1
increment by 1;

create sequence customercenter_seq --coupon
start with 1
increment by 1;

create sequence customercenter_answer_seq --coupon
start with 1
increment by 1;

create sequence review_number_seq --coupon
start with 1
increment by 1;

create sequence review_answer_seq --coupon
start with 1
increment by 1;
