...
public class TourOptionVo {
	...
	public TourOptionVo(int tour_option_number, int tour_price, int tour_option_index, String tour_option,
			int tour_amount) {
		super();
	...
	public String toString() {
		return "TourOptionVo [tour_option_number=" + tour_option_number + ", tour_price=" + tour_price
				+ ", tour_option_index=" + tour_option_index + ", tour_option=" + tour_option + ", tour_amount="
				+ tour_amount + "]";
	}
}
