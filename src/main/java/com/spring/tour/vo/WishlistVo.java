...
public class WishlistVo {
	...
	private int dcprice; // tour_price에 할인 붙어 있으면 계산해서 가져오는 할인된 가격  tip. 할인 없으면 tour_price 들어옴. 정렬위한 변수
	...
	public WishlistVo(int cate_number, int service_number, int wishnum, String user_id, String tour_type,
			...
			int tour_amount, int discount, int dcnt, int dcprice) {
		super();
