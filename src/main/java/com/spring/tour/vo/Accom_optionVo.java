...
public class Accom_optionVo {
	...
	public void setAccom_total(int accom_total) {
		this.accom_total = accom_total;
	}
	...
	public String toString() {
		return "Accom_roomsVo [accom_option_number=" + accom_option_number + ", accom_service_number="
				+ accom_service_number + ", accom_rooms_option=" + accom_rooms_option + ", accom_total=" + accom_total
				+ ", accom_count=" + accom_count + ", accom_price=" + accom_price + "]";
	}
