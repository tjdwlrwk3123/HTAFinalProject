...
public class TourDetailVo {
	...
	public TourDetailVo(int cate_number, int service_number, int minp, String tour_addr, String tour_name,
			Date tour_expire, String tour_how, String tour_rule, Double avgpoint) {
		super();
	...
	public String toString() {
		return "TourDetailVo [cate_number=" + cate_number + ", service_number=" + service_number + ", minp=" + minp
				+ ", tour_addr=" + tour_addr + ", tour_name=" + tour_name + ", tour_expire=" + tour_expire
				+ ", tour_how=" + tour_how + ", tour_rule=" + tour_rule + ", avgpoint=" + avgpoint + "]";
	}
