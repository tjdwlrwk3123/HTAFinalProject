...
@Controller
public class CustomercenterListController {
	@Autowired
	private CustomercenterService service;
	
	@RequestMapping("/customercenter/list")
	public ModelAndView list(@RequestParam(value = "pageNum", defaultValue = "1")int pageNum, String field, String keyword) {
		...
		List<CustomercenterVo> list=service.list(map);
		
		ModelAndView mv=new ModelAndView("customercenter/list");
