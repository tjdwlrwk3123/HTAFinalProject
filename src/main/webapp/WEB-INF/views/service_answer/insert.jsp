...
<body>
<h1>글등록</h1>
<form method="post" action="${cp }/service_answer/insert">
작성자아이디<br>
		...
		<br>
		문의번호
		<input type="text" name="service_question_number">
		<br>
		답변제목<br>
		<input type="text" name="service_answer_title">
		<br>
		답변내용<br>
		<textarea rows="5" cols="100" name="service_answer_content"></textarea><br>
