...
<style>
 ...
 #couponWrap .couponPaging{
  ...
  #couponWrap #keywordSearchCoupon form *{
  	margin-right: 10px;
  }
...
<table id="coupontbl">
	...
	<tr>
		...
		<td>
			...
			<button class="btn btn-outline-danger">쿠폰삭제</button>
			</form>
		</td>
	</tr>
	</c:forEach>
...
<form action="${cp }/couponManage" method="post" class="d-flex">
	...
	<input type="text" name="picker" id="picker" class="form-control me-2" value="${picker }" readonly="readonly" style="display: none;">
	<input type="text" name="keyword" id="notpicker" class="form-control me-2" value="${keyword }">
	<input type="submit" value="검색" class="btn btn-outline-success">
</form>
</div>
<div id="createCoup">
<a href="${cp }/goCreateCoupon" class="btn btn-outline-secondary">쿠폰발급</a>
<a href="javascript:couponDisposal()" class="btn btn-outline-secondary">쿠폰정리</a>
